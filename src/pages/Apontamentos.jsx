...
import { PlusIcon, ArrowPathIcon, CheckIcon, XMarkIcon, WrenchScrewdriverIcon, DocumentArrowDownIcon } from "@heroicons/react/24/solid";
...
export default function Apontamentos() { 
  ...
  function onBuildPreview() { 
    ...
    const validasSemConflito = p.validas.filter((v) => 
      !existentes.has(`${v.funcionario_id}|${v.data}|${v.turno_ordem}|${v.origem}`)
    ); 
  ...
  return ( 
    <> 
      ...
      <style jsx>{` 
        ...
        .apontamentos-table td { 
          white-space: nowrap; 
        } 
        .apontamentos-table td:first-child, 
        .apontamentos-table th:first-child { 
          white-space: normal; 
        } 
        .obs-cell { 
          max-width: 280px; 
